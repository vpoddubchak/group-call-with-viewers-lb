...
public class UserSession implements Closeable {
  ...
  public UserSession(final String name, String roomName, Boolean streamer, final WebSocketSession session,
  ...
  public Boolean getStreamerBool() {
  ...
  public void receiveVideoFrom(UserSession sender, String sdpOffer) throws IOException {
    ...
    scParams.addProperty("streamer", sender.getStreamer());
...
//    incoming.setMaxVideoRecvBandwidth(150);
//    incoming.setMaxVideoSendBandwidth(150);
